...
const Home = () => {
  ...
  const whyOrbY1 = useTransform(whyProgress, [0, 1], [-50, 50]);
  const whyOrbY2 = useTransform(whyProgress, [0, 1], [40, -40]);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <motion.div
          style={{ y: whyOrbY1 }}
          className="absolute bottom-0 right-0 w-96 h-96 bg-brand-purple/[0.03] rounded-full blur-[100px] pointer-events-none"
        />
        <motion.div
          style={{ y: whyOrbY2 }}
          className="absolute top-0 left-0 w-80 h-80 bg-brand-accent/[0.02] rounded-full blur-[80px] pointer-events-none"
        />
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      {/* Hover gradient */}
                      <div className="absolute inset-0 bg-gradient-to-r from-brand-purple/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400" />
                      {/* Left accent bar */}
              ...
              <div className="relative w-full aspect-square max-w-lg mx-auto select-none">
                ...
                >
                  ...
                  <motion.circle
                    ...
                    strokeWidth="0.8"
                    opacity="0.12"
                    animate={{ r: [42, 48, 42], opacity: [0.12, 0.06, 0.12] }}
                    transition={{
                      duration: 6,
                      repeat: Infinity,
                      ease: "easeInOut",
