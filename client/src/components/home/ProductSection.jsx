          ...
          <AnimatedSection direction="left">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-secondary-500 mt-6 mb-12 leading-relaxed">
                <span className="font-bold text-secondary-900">CoreSight</span> is Coxara's flagship platform, built on our deep data engineering experience and designed to combine natural language intelligence with enterprise-scale analytics.
              </p>
