...
const HeroVisual = ({ mouseX, mouseY }) => {
  ...
  const rotateX = useSpring(useTransform(mouseY, [0, 1000], [5, -5]), { stiffness: 60, damping: 20 });
  const rotateY = useSpring(useTransform(mouseX, [0, 1500], [-5, 5]), { stiffness: 60, damping: 20 });
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div style={{ y: textY }}>
            ...
            >
              Roxbee is a swarm intelligence–driven analytics platform where distributed data, models, and signals interact to produce coordinated, governed decisions in real time.
            </motion.p>
