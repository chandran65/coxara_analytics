...
const CapabilitiesGrid = () => {
  const items = [
    ...
    },
    {
      ...
      category: "Industry",
      type: "Industry",
      description: "Predict, report, and mitigate risk with AI built for financial precision.",
      icon: (
    ...
    },
    {
      ...
      category: "Industry",
      type: "Industry",
      description: "Engage and retain. Segment audiences and predict churn in real-time.",
      icon: (
  ...
  return (
    <section className="py-24 md:py-32 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.015] pointer-events-none" 
             style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, #6D28D9 1px, transparent 0)', backgroundSize: '48px 48px' }} />
