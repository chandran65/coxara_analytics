            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="space-y-4 text-base md:text-lg text-secondary-600 leading-relaxed">
                {[
                  ...
                  "We are the team behind Beacon — our flagship Enterprise intelligence platform that lets business leaders chat with their data in plain English. No SQL, no data prep, no guesswork. Just clear, verifiable answers backed by your actual data.",
