      ...
      <div className="container-custom relative z-10">
        ...
        <div className="py-12 lg:py-16">
          ...
          >
            ...
            >
              <Link to="/" className="inline-block group mb-8 relative overflow-hidden rounded-md h-16 w-72">
                <img
                  src="/geometric_c_nodes.png"
                  alt="COXARA Analytics"
                  className="absolute left-[-2%] top-1/2 -translate-y-1/2 w-[115%] max-w-none h-auto mix-blend-multiply opacity-95 transition-transform duration-300 group-hover:scale-105 group-hover:opacity-100 origin-left"
                />
              </Link>
