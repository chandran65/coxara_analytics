...
const TypingIndicator = () => (
  <div className="flex items-end gap-2 mb-3">
    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-brand-purple to-brand-medium flex-shrink-0 flex items-center justify-center text-white text-xs font-bold">
      C
    </div>
        ...
        {open && (
          ...
          >
            ...
            <div className="flex-shrink-0 bg-gradient-to-r from-brand-purple to-brand-medium px-5 py-4 flex items-center gap-3 relative overflow-hidden">
              ...
              <div className="relative w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center flex-shrink-0">
